...
const Editfood = (props) => {
    ...
    useEffect(() => {
        ...
        axios
            .post("http://localhost:4000/food/find/", User)
            .then((res) => {
                ...
                setNo_of_users(res.data.no_of_users);
            })
    ...
    return (
        <div>
            ...
            <Grid container align={"center"} spacing={2}>
                ...
                <Grid item xs={12}>
                    <Button variant="outlined" onClick={addTags}>
                        Add Tag
                    </Button>
                </Grid>
                <Grid item xs={12}>
                {addons.map((current_object, i) => {
                ...
                <Grid item xs={12}>
                    <Button variant="outlined" onClick={addAddon}>
                        Update Add on
                    </Button>
                </Grid>
                <Grid item xs={12}>
                ...
                <Grid item xs={12}>
                    <Button variant="outlined" onClick={resetTags}>
                        Reset Tags
                    </Button>
                </Grid>
                <Grid item xs={12}>
                    <Button variant="outlined" onClick={resetAddons}>
                        Reset Addons
                    </Button>
                </Grid>
            </Grid>
